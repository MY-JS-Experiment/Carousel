...
jQuery.fn.extend( {
	...
	position: function() {
		...
		console.log("offset: "+offset.left +"parentTop: "+ parentOffset.left +"jqueryCss: "+ jQuery.css( elem, "marginLeft", true ))
		console.log("Left: "+(offset.left - parentOffset.left - jQuery.css( elem, "marginLeft", true )))
		return {
